...
public class WebDavServletController {
	...
	WebDavServletController(ServletContextHandler contextHandler, ContextHandlerCollection contextHandlerCollection,
							ServerConnector connector, ContextPathRegistry contextPathRegistry, String contextPath,
		...
		this.contextHandler.setSecurityHandler(securityHandler);
	}
